...
{
    private static final String TAG = "ViewPatientsFragment";

    //private String testImageURL = "image.shutterstock.com/z/stock-vector-patient-icon-medical-health-care-person-with-cross-symbol-vector-illustration-554075461.jpg";

    public interface OnPatientSelectedListener
    {
        public void OnPatientSelected(Patient pat);
    }
    OnPatientSelectedListener mPatientListener;

    public interface OnAddPatientListener
    {
        public void OnAddPatient();
    }
    OnAddPatientListener mOnAddPatient;
    ...
    {
        View view = inflater.inflate(R.layout.fragment_viewpatients,container,false);
        viewPatientBar = view.findViewById(R.id.viewPatientToolBar);
        searchBar = view.findViewById(R.id.searchToolBar);
        patientsList =  view.findViewById(R.id.patientsList);
         ...
         * *//*
        String myValue = this.getArguments().getString("Key1");*/
        ...
        fab.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) 
            {
                ...
                mOnAddPatient.OnAddPatient();
            }
        });

        ImageView ivSearchPatient = (ImageView) view.findViewById(R.id.ivSearchIcon);
        ...
        ImageView ivBackArrow = (ImageView) view.findViewById(R.id.ivBackArrow_teal);
        ...
        ImageView ivBackArrow2 = (ImageView) view.findViewById(R.id.ivBackArrow);
        ivBackArrow2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                /*//Create a new Intent to back to the mainActivity.
    ...
    public void onAttach(@NonNull Context context)
    {
        ...
        try {
            mPatientListener = (OnPatientSelectedListener) getActivity();
            mOnAddPatient = (OnAddPatientListener) getActivity();
    ...
    private void setupPatientsList()
    {
         ...
         * Getting the key from other activity so the animation not gonna work again.
         * */
        //final String clientValue = this.getArguments().getString("Key1");

        final ArrayList<Patient> patients = new ArrayList<>();
//        patients.add(new Patient("Patient", "(213) 665-4777", 15, 18, 18, testImageURL));
        ...
        patientsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {
               /* if (clientValue == "calcPatient")
                {
                    Log.d(TAG, "onItemClick: navigate to calculationActivity");
                }else
                {*/
                    ...
                    mPatientListener.OnPatientSelected(patients.get(position));
                /*}*/
            }
        });
