...
public class ViewMedicinesFragment extends Fragment
{
    private static final String TAG = "ViewMedicinesFragment";

    public interface OnMedicineSelectedListener
    {
        public void OnMedicineSelected(Medicine pat);
    }
    OnMedicineSelectedListener mMedicineListener;

    public interface OnAddMedicineListener
    {
        public void OnAddMedicine();
    }
    OnAddMedicineListener mOnAddMedicine;
    ...
    {
        View view = inflater.inflate(R.layout.fragment_viewmedicines,container,false);
        viewMedicineBar = view.findViewById(R.id.viewMedicinesToolBar);
        searchBar =  view.findViewById(R.id.searchToolBar);
        medicinesList =  view.findViewById(R.id.medicinesList);
        ...
        // Navigate to add medicine fragment
        FloatingActionButton fab = view.findViewById(R.id.fabAddMedicine);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            mMedicineListener = (OnMedicineSelectedListener) getActivity();
            mOnAddMedicine = (OnAddMedicineListener) getActivity();
...
//      patients.add(new Patient("Medicine", "(213) 665-4777", 15, 18, 18, testImageURL));
        ...
        //Sort the array list based on the medicine Name.
        ...
        medicinesList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                mMedicineListener.OnMedicineSelected(medicines.get(position));
            }
        });
